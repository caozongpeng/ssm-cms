...
CREATE TABLE `article`  (
  ...
  `date` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `category`  (
  ...
  `display_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `comments`  (
  ...
  `comm_ip` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'kyrie', '123456');
